    ...
    <table class="table table-bordered table-striped" id="table-view">
        ...
        <tbody class="rouded shadow">
                    ...
                    <tr>
                        ...
                        <td class='actions'>
                            <div class="d-flex flex-column flex-md-row gap-2 justify-content-center">
                                <a class="btn btn-sm btn-primary me-1 view-btn"
                                    href="<?= $BASE_URL ?>show.php?id=<?= $patient['id'] ?>"><i class="fas fa-eye"></i></a>
                                <a class="btn btn-sm btn-warning me-1 edit-btn"
                                    href="<?= $BASE_URL ?>cadastro.php?id=<?= $patient['id'] ?>"><i class="fas fa-edit"></i></a>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="4">
                        <p id="empty-list-text"> Ainda não há pacientes cadastrados. Clique em<a
                                href="<?= $BASE_URL ?>cadastro.php" class="fw-bold">Criar novo Cadastro</a>para adicionar um
                            novo paciente.</p>
                    </td>
                </tr>
            <?php endif; ?>
