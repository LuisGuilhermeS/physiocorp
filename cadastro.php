...
?>
            ...
            <!--dados pessoais-->
        <form id="patientForm">
            <?php include 'dados_pessoais.php'; ?>
                ...
                <div class="card-body">
                    <div class="human-body">
                        <div class="body-part" id="frontBody">
                            <img src="img/frente_verso.webp" alt="Human body illustration viewed from the front standing upright with arms slightly away from the sides neutral expression on a plain white background no text present calm and clinical atmosphere">
                        ...
                        <div class="body-part" id="backBody">
                            <img src="https://cdn.pixabay.com/photo/2017/08/01/08/29/people-2562325_960_720.png" alt="Corpo humano - costas">
