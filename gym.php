...
$patient_record = [
  ['id' => 1, 'nome' => 'Mathias', 'telefone' => '991122324'],
  ['id' => 2, 'nome' => 'Julia', 'telefone' => '981234567'],
  ['id' => 3, 'nome' => 'Carlos', 'telefone' => '997899900'],
  ];
...
<div class="row">
  <div class="col-8 mx-auto">
    ...
    <!-- Contêiner para mostrar o calendário -->
  </div>
  <div class="col-4">
...
<script>
  const pacientes = [
    { id: 1, freq: { '2025-5': [1, 3, 5] } },
    { id: 2, freq: { '2025-5': [2, 4, 8, 12, 14, 16, 20, 28] } },
    { id: 3, freq: {} }
  ];
